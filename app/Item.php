...
class Item
{
    ...
    public static function all(World $world)
    {
        ...
        static::$items[$world->id] = new ItemCollection([
            ...
            new Item\Ring('RupeeRing', [0xB0], $world),
            new Item\Ring('GravityRing', [0xB1], $world),
            new Item\Ring('FireRing', [0xB2], $world),
            new Item\Ring('FlameRing', [0xB3], $world),
            new Item\Ring('LightRing', [0xB4], $world),
            new Item\Ring('PowerRing', [0xB5], $world),
            new Item\Ring('SwordRing', [0xB6], $world),
            new Item\Ring('GuardRing', [0xB7], $world),
            new Item\Ring('DiamondRing', [0xB8], $world),
            new Item\Ring('ProgressiveFireRing', [0xB9], $world),
            new Item\Ring('ProgressivePowerRing', [0xBA], $world),
            new Item\Ring('ProgressiveGuardRing', [0xBB], $world),
